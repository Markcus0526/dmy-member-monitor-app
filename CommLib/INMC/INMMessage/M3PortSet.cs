...
namespace INMC.INMMessage
{
    ...
    /// </summary>
    [Serializable]
    public class M3PortSet : MessageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public M3PortSet()
        {
            MsgKind = MessageType.KIND.MSG3_PORTSET;
    ...
    /// </summary>
    [Serializable]
    public class M3PortRule
    {
        /// <summary>
        /// 
        /// </summary>
        public int nType = 0;  // 0: Add, 1: Modify, 2: Delete

...
namespace INMC.INMMessage
{
    ...
    /// </summary>
    [Serializable]
    public class M6MsgSend : MessageBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public M6MsgSend()
        {
            MsgKind = MessageType.KIND.MSG6_MSGSEND;
        ...
        public override byte[] GetByteArray()
        {
            ...
            //Add your codes here
            MsgDataConverter.WriteStringField(memStream, strMessage);
        ...
        public override void Initialize(byte[] byteArray)
        {
            ...
            //Add your codes here
            strMessage = MsgDataConverter.ReadStringField(memStream);
        }
    }
}

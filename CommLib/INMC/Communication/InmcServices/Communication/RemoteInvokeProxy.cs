...
namespace INMC.Communication.InmcServices.Communication
{
    /// <summary>
    ...
    internal class RemoteInvokeProxy<TProxy, TMessenger> : RealProxy where TMessenger : IMessenger
    {
        ...
        public override IMessage Invoke(IMessage msg)
        {
            ...
            var requestMessage = new InmcRemoteInvokeMessage
            {
            ...
            var responseMessage = _clientMessenger.SendMessageAndWaitForResponse(requestMessage) as InmcRemoteInvokeReturnMessage;

...
namespace INMC.Communication.Inmc.Communication.Messages
{
    ...
    /// </summary>
    [Serializable]
    public sealed class InmcPingMessage : InmcMessage
    {
        ///<summary>
        /// Creates a new PingMessage object.
        ///</summary>
        public InmcPingMessage()
        {
        ...
        /// a message.
        /// </param>
        public InmcPingMessage(string repliedMessageId)
            : this()
        {
        ...
        public override string ToString()
        {
            return string.IsNullOrEmpty(RepliedMessageId)
                       ? string.Format("InmcPingMessage [{0}]", MessageId)
                       : string.Format("InmcPingMessage [{0}] Replied To [{1}]", MessageId, RepliedMessageId);
        }
    }
}

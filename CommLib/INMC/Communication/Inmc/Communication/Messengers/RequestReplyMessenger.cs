...
using INMC.Threading;

namespace INMC.Communication.Inmc.Communication.Messengers
{
    /// <summary>
    ...
    public class RequestReplyMessenger<T> : IMessenger, IDisposable where T : IMessenger
    {
        ...
        /// </summary>
        public IInmcWireProtocol WireProtocol
        {
        ...
        /// </summary>
        private readonly SequentialItemProcessor<IInmcMessage> _incomingMessageProcessor;
        ...
        public RequestReplyMessenger(T messenger)
        {
            ...
            _incomingMessageProcessor = new SequentialItemProcessor<IInmcMessage>(OnMessageReceived);
        ...
        public void SendMessage(IInmcMessage message)
        {
        ...
        public IInmcMessage SendMessageAndWaitForResponse(IInmcMessage message)
        {
        ...
        public IInmcMessage SendMessageAndWaitForResponse(IInmcMessage message, int timeoutMilliseconds)
        {
        ...
        protected virtual void OnMessageReceived(IInmcMessage message)
        {
        ...
        /// </summary>
        /// <param name="message">Received message</param>
        protected virtual void OnMessageSent(IInmcMessage message)
        {
        ...
        private sealed class WaitingMessage
        {
            ...
            /// </summary>
            public IInmcMessage ResponseMessage { get; set; }

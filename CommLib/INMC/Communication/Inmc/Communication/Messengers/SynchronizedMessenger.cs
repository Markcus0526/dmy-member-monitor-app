...
namespace INMC.Communication.Inmc.Communication.Messengers
{
    ...
    public class SynchronizedMessenger<T> : RequestReplyMessenger<T> where T : IMessenger
    {
        ...
        /// </summary>
        private readonly Queue<IInmcMessage> _receivingMessageQueue;
            ...
            : base(messenger)
        {
            ...
            _receivingMessageQueue = new Queue<IInmcMessage>();
        ...
        public IInmcMessage ReceiveMessage()
        {
        ...
        public IInmcMessage ReceiveMessage(int timeout)
        {
            while (_running)
            {
                lock (_receivingMessageQueue)
        ...
        /// </summary>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>() where TMessage : IInmcMessage
        {
        ...
        /// </param>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>(int timeout) where TMessage : IInmcMessage
        {
        ...
        protected override void OnMessageReceived(IInmcMessage message)
        {
            lock (_receivingMessageQueue)
            {

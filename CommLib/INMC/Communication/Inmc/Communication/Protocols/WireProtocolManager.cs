using INMC.Communication.Inmc.Communication.Protocols.BinarySerialization;
...
namespace INMC.Communication.Inmc.Communication.Protocols
{
    ...
    internal static class WireProtocolManager
    {
        ...
        public static IInmcWireProtocolFactory GetDefaultWireProtocolFactory()
        {
        ...
        /// </summary>
        /// <returns>A new instance of default wire protocol</returns>
        public static IInmcWireProtocol GetDefaultWireProtocol()
        {

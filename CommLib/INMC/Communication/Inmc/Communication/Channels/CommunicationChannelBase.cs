...
namespace INMC.Communication.Inmc.Communication.Channels
{
    ...
    internal abstract class CommunicationChannelBase : ICommunicationChannel
    {
        ...
        ///</summary>
        public abstract InmcEndPoint RemoteEndPoint { get; }
        ...
        /// </summary>
        public IInmcWireProtocol WireProtocol { get; set; }
        ...
        /// </summary>
        /// <param name="message">Message to be sent</param>
        protected abstract void SendMessageInternal(IInmcMessage message);

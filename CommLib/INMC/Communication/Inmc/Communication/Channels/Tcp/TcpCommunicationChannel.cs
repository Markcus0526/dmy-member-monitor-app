...
namespace INMC.Communication.Inmc.Communication.Channels.Tcp
{
    /// <summary>
    ...
    internal class TcpCommunicationChannel : CommunicationChannelBase
    {
        ...
        ///</summary>
        public override InmcEndPoint RemoteEndPoint
        {
            get
            {
        ...
        private readonly InmcTcpEndPoint _remoteEndPoint;
        ...
        public TcpCommunicationChannel(Socket clientSocket)
        {
            ...
            _remoteEndPoint = new InmcTcpEndPoint(ipEndPoint.Address.ToString(), ipEndPoint.Port);
        ...
        protected override void SendMessageInternal(IInmcMessage message)
        {
            //Send message
            var totalSent = 0;
            lock (_syncLock)

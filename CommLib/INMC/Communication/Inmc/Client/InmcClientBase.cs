...
namespace INMC.Communication.Inmc.Client
{
    ...
    /// </summary>
    internal abstract class InmcClientBase : IInmcClient
    {
        ...
        private IInmcWireProtocol _wireProtocol;
        ...
        {
            if (e.Message is InmcPingMessage)
            {
                return;
            }
        ...
        private void PingTimer_Elapsed(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _communicationChannel.SendMessage(new InmcPingMessage());
            }
            catch
            {

...
namespace INMC.Communication.Inmc.Server
{
    ...
    /// </summary>
    internal class InmcServerClient : IInmcServerClient
    {
        ...
        private void CommunicationChannel_MessageReceived(object sender, MessageEventArgs e)
        {
            ...
            if (message is InmcPingMessage)
            {
                _communicationChannel.SendMessage(new InmcPingMessage { RepliedMessageId = message.MessageId });
                return;
            }
        ...
        private void OnMessageReceived(IInmcMessage message)
        {

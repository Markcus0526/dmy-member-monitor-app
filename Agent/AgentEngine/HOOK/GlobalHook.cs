...
namespace AgentEngine
{
    ...
    public abstract class GlobalHook
    {
        ...
        protected static extern bool GetKeyboardState(byte[] lpKeyState);

        [DllImport("user32.dll")]
        protected static extern bool SetKeyboardState(byte[] lpKeyState);
        ...
        #region Constants
        public const int CUSTSKEYSTROKE = 0x10;
        #endregion
        ...
        public void Start()
        {
                ...
                _hookType != 0)
            {
                ...
                if (ComMisc.vistaOverOS == true)
                    ...
                    hMod = Process.GetCurrentProcess().MainModule.BaseAddress;

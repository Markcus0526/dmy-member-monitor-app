...
namespace AgentWebInet
{
    class Program
    {
        private static String subInternetKey = @"Software\Microsoft\Windows\CurrentVersion\Internet Settings";
        private static String strProxyServer = "0.0.0.1:1111";
        ...
        static void Main(string[] args)
        {
            ...
            RegistryKey key = Registry.CurrentUser.OpenSubKey(subInternetKey, true);

            key.SetValue("ProxyEnable", (bEnable) ? 0 : 1);
            key.SetValue("ProxyServer", (bEnable) ? "" : strProxyServer);
            ...
            if (bEnable)
                ...
                WinInetInterop.SetConnectionProxy(strProxyServer);
